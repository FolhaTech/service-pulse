...
> = {
  ...
  meta: {
    modelProps: 'contact' | 'responsible' | 'channel' | 'survey' | 'upload' | 'surveyResponse';
    ...
    SurveyResponse: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            runtime.Types.Utils.Optional<Prisma.SurveyResponseCountAggregateOutputType> | number;
        };
      };
    };
  };
...
export type ResponsibleScalarFieldEnum =
  (typeof ResponsibleScalarFieldEnum)[keyof typeof ResponsibleScalarFieldEnum];
 ...
 */
export type EnumResponseStatusFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'ResponseStatus'
>;
